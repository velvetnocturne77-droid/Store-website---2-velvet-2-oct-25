...
export const mockProducts: Product[] = [
  { 
    ...
    image: 'https://i.imgur.com/MsxTzKJ.png, 
    variants: [
  ...
  { 
    ...
    image: 'https://i.imgur.com/ppeXJSR.png',
    variants: [
      { id: 'draven-2-100', size: '100ml', price: 3200, discountedPrice: 2399, stock: 5 },
      { id: 'draven-2-50', size: '50ml', price: 2300, discountedPrice: 1659, stock: 5 },
    ]
  },
  { 
    id: 'auron-3', 
    ...
    image: 'https://i.imgur.com/U1JpgOa.jpeg',
    variants: [
